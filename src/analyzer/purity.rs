...
fn expr_touches_impure(
    ...
    match &expr.kind {
        ...
        TypedExprKind::Try(e) | TypedExprKind::Ignore(e) => expr_touches_impure(e, impure),
        TypedExprKind::Implements { expr: e, .. } => expr_touches_impure(e, impure),
        TypedExprKind::TypeName { expr: e } => expr_touches_impure(e, impure),
        TypedExprKind::AsDowncast { expr: e, .. } => expr_touches_impure(e, impure),
